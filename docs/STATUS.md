...
- The exact stock archive and read-only recovery gate pass, but a full Odin
  factory restore has not been exercised end-to-end because it would erase the
  accepted dual-boot installation.
