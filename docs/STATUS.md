...
| Release packaging | In progress | Deterministic first-boot, desktop runtime, source-only hardware orchestration, and six-binary ARM64 native-userspace packages pass native extraction and runtime probes; compiled hardware daemons, locally generated stock assets, root assembly, and recovery rehearsal remain |
