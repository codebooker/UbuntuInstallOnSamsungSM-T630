...
`t630-camera-runtime_0.1.2_arm64.deb` from tracked scripts plus five ARM64
helpers built from repository source. Two packages built with the same epoch
were byte-identical.

- size: 53,680 bytes
- SHA256: `ab475d8df972e23c02d3d92dec380c37ece3e3d88d52dfdcbba24ac6b3ae6d1d`
- architecture: ARM64
...
restored camera-runtime 0.1.2 and release-base 0.1.7 with both audits clean.

The exact release closure is now thirteen components plus release-base 0.1.7,
