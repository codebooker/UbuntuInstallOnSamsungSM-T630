...
EXPECTED = {
    ...
    "t630-desktop-runtime_0.1.9_all.deb": (
        "t630-desktop-runtime", "0.1.9",
        "a22e5b145e2e39d7deb608cb102f2bfbf59275d1e32c3a884f03dceb51dfe645"),
    ...
    "t630-release-base_0.1.18_arm64.deb": (
        "t630-release-base", "0.1.18",
        "821d592702683827a4d1adc2852d084f6e51a195343c69057fb6440de1997902"),
}
INSTALL_ORDER = tuple(name for name in EXPECTED if not name.startswith("t630-release-base_"))
META_PACKAGE = "t630-release-base_0.1.18_arm64.deb"
