...
Depends: t630-first-boot (= 0.1.3), t630-desktop-runtime (>= 0.1.12), t630-hardware-runtime (>= 0.1.6), t630-stock-assets (>= 1.0.2+dze3), python3, python3-gi, gir1.2-gtk-4.0, sudo, dmsetup, util-linux, pipewire, gstreamer1.0-tools, gstreamer1.0-plugins-base, gstreamer1.0-plugins-good, gnome-snapshot
Section: admin
Priority: optional
