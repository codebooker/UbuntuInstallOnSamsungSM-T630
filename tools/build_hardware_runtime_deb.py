...
Depends: t630-desktop-runtime (>= 0.1.5), python3, network-manager, wpasupplicant, bluez, pipewire, pipewire-pulse, pulseaudio-utils, wireplumber, alsa-utils, iio-sensor-proxy, util-linux
