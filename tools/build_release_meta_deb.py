...
Description: exact native Ubuntu base package set for Samsung SM-T630
 Pulls together the reproducible device integration and the owner's private
 exact-DZE3 stock-assets package. Android camera compatibility is not included.
""".encode()
    package = b"!<arch>\n"
