#!/bin/sh
# Write only the verified SM-T630 Bluetooth kernel boot image.
set -eu

mode=${1:---check}
image=/var/tmp/t630-bluetooth-h4-v2.img
old_hash=297cf31e5914ff6a17d1e1d6499d2af2a493022c56336978b76e61e14b9c910a
new_hash=6521d481b71ca23e30228c913df75377f5589ff1e2c9005ed71ccb4c625903a0
...
if [ "$mode" = --check ]; then
    echo BLUETOOTH_BOOT_WRITE_READY
    exit 0
fi
...
echo BLUETOOTH_BOOT_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
