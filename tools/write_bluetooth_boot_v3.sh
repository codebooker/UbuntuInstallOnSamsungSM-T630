#!/bin/sh
# Write only the verified SM-T630 kernel with restored Bluetooth HCI sockets.
set -eu

mode=${1:---check}
image=/var/tmp/t630-bluetooth-h4-v3.img
old_hash=6521d481b71ca23e30228c913df75377f5589ff1e2c9005ed71ccb4c625903a0
new_hash=464e4900a841dc59c1ac82380812b9e7feff78843735a7216b1afe9bde466bd4
...
if [ "$mode" = --check ]; then
    echo BLUETOOTH_HCI_SOCKET_BOOT_WRITE_READY
    exit 0
fi
...
echo BLUETOOTH_HCI_SOCKET_BOOT_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
