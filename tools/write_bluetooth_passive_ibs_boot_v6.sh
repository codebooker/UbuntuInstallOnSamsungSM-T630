#!/bin/sh
# Write only the verified SM-T630 kernel with passive Qualcomm IBS handling.
set -eu

mode=${1:---check}
image=/var/tmp/t630-bluetooth-passive-ibs-v6.img
old_hash=260ff8e23da2934ee4143ab0ac50baeb35adb295763585bb301fb99295382dd1
new_hash=4e0b389ecd9884d4cb57e077b08902e721870dea750130119b7d1de794c4cf11
...
if [ "$mode" = --check ]; then
    echo BLUETOOTH_PASSIVE_IBS_BOOT_WRITE_READY
    exit 0
fi
...
echo BLUETOOTH_PASSIVE_IBS_BOOT_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
