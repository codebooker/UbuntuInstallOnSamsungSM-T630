#!/bin/sh
# Write only the verified SM-T630 kernel with the corrected QCA handoff baud.
set -eu

mode=${1:---check}
image=/var/tmp/t630-bluetooth-qca-v5.img
old_hash=9dd1ef688b578e574c148daacddf0d2f57e7c0408ac8ca024fb5eb0c0f21eaea
new_hash=260ff8e23da2934ee4143ab0ac50baeb35adb295763585bb301fb99295382dd1
