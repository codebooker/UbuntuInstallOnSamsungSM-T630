#!/bin/sh
# Write only the verified SM-T630 kernel with Samsung's WCN6850 RXD wake pulse.
set -eu

mode=${1:---check}
image=/var/tmp/t630-bluetooth-rxd-wakeup-v7.img
old_hash=4e0b389ecd9884d4cb57e077b08902e721870dea750130119b7d1de794c4cf11
new_hash=c9fd8a0025e2c8acc8c7781a077c2af71eb49c01688cf9ae010a4bc8c15118db
...
if [ "$mode" = --check ]; then
    echo BLUETOOTH_RXD_WAKEUP_BOOT_WRITE_READY
    exit 0
fi
...
echo BLUETOOTH_RXD_WAKEUP_BOOT_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
