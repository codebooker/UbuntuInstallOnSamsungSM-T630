#!/bin/sh
# Write only the reproducible, offline-verified SM-T630 release boot candidate.
set -eu

mode=${1:---check}
image=/var/tmp/t630-release-boot-v1.img
old_hash=5394a2347dd4ed660af02e7197c48a38b91c6912a6a0667b4cd002dc16c21b61
new_hash=1462fb6f5f97a347a6c9bba231b479dc1d17f13617dfc6ec78149c00afe85fff
...
if [ "$mode" = --check ]; then
    echo RELEASE_BOOT_V1_WRITE_READY
    exit 0
fi
...
echo RELEASE_BOOT_V1_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
