#!/bin/sh
# Write only the verified one-shot clean-root SM-T630 boot candidate.
set -eu

mode=${1:---check}
image=/var/tmp/t630-release-boot-v2.img
old_hash=1462fb6f5f97a347a6c9bba231b479dc1d17f13617dfc6ec78149c00afe85fff
new_hash=ce279665976b877bc1442d9c027963f5774a8a7e60d4935072bfea7544ec3c14
...
if [ "$mode" = --check ]; then
    echo RELEASE_BOOT_V2_WRITE_READY
    exit 0
fi
...
echo RELEASE_BOOT_V2_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
