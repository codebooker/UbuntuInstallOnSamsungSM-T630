#!/bin/sh
# Write only the verified ownerless-recovery SM-T630 boot candidate.
set -eu

mode=${1:---check}
image=/var/tmp/t630-release-boot-v3.img
old_hash=ce279665976b877bc1442d9c027963f5774a8a7e60d4935072bfea7544ec3c14
new_hash=2d9ebe83d1bbc3d3f1495c5004fd06a8e3a250782ba00a1b5416df2542d5acc4
...
if [ "$mode" = --check ]; then
    echo RELEASE_BOOT_V3_WRITE_READY
    exit 0
fi
...
echo RELEASE_BOOT_V3_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
