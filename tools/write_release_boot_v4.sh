#!/bin/sh
# Write only the verified personalized-startup SM-T630 boot candidate.
set -eu

mode=${1:---check}
image=/var/tmp/t630-release-boot-v4.img
old_hash=2d9ebe83d1bbc3d3f1495c5004fd06a8e3a250782ba00a1b5416df2542d5acc4
new_hash=368279fde4962e2b2ff44b093892f58c872bf63c080c6938d489aa40fca06175
...
if [ "$mode" = --check ]; then
    echo RELEASE_BOOT_V4_WRITE_READY
    exit 0
fi
...
echo RELEASE_BOOT_V4_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
