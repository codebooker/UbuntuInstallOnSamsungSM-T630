#!/bin/sh
# Write only the verified desktop-power-actions SM-T630 boot candidate.
set -eu

mode=${1:---check}
image=/var/tmp/t630-release-boot-v5.img
old_hash=368279fde4962e2b2ff44b093892f58c872bf63c080c6938d489aa40fca06175
new_hash=d1f475dc2e2194f0ccfc03d83d06102e72a5c1ac4a9e76ed4e622f7121010638
...
if [ "$mode" = --check ]; then
    echo RELEASE_BOOT_V5_WRITE_READY
    exit 0
fi
...
echo RELEASE_BOOT_V5_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
