#!/bin/sh
# Write only the verified clean-root-persistence SM-T630 boot candidate.
set -eu

mode=${1:---check}
image=/var/tmp/t630-release-boot-v6.img
old_hash=d1f475dc2e2194f0ccfc03d83d06102e72a5c1ac4a9e76ed4e622f7121010638
new_hash=ca7caa12d1228969b264815bf69f34dbbee5ced9e3a86d1134c590bff8c895dc
...
if [ "$mode" = --check ]; then
    echo RELEASE_BOOT_V6_WRITE_READY
    exit 0
fi
...
echo RELEASE_BOOT_V6_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
