#!/bin/sh
# Write only the offline-verified SM-T630 Waydroid-prerequisite boot image.
set -eu

mode=${1:---check}
image=/var/tmp/t630-waydroid-kernel-v9.img
old_hash=2bfa801e391476fb9e4f597d31846fc2113b8c0c761130caa4a7fef4dec1876a
new_hash=57b5d0c8a1ef76f46ea0c6c039d30a2f13e7b3743c5c7d1a72eb5f4eb10a993b
...
if [ "$mode" = --check ]; then
    echo WAYDROID_KERNEL_BOOT_WRITE_READY
    exit 0
fi
...
echo WAYDROID_KERNEL_BOOT_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
