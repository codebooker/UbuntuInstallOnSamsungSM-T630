#!/bin/sh
# Write only the offline-verified, factory-module-compatible SM-T630 boot image.
set -eu

mode=${1:---check}
image=/var/tmp/t630-wifi-safe-checksum-v10.img
old_hash=57b5d0c8a1ef76f46ea0c6c039d30a2f13e7b3743c5c7d1a72eb5f4eb10a993b
new_hash=5394a2347dd4ed660af02e7197c48a38b91c6912a6a0667b4cd002dc16c21b61
...
if [ "$mode" = --check ]; then
    echo WIFI_SAFE_CHECKSUM_BOOT_WRITE_READY
    exit 0
fi
...
echo WIFI_SAFE_CHECKSUM_BOOT_WRITTEN_READBACK_VERIFIED_PROTECTED_PARTITIONS_UNCHANGED
